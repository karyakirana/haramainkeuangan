            ...
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true" data-kt-menu-expand="false">
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('dashboard*') ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('dashboard/keuangan') ? 'active' : ''}}" href="{{route('dashboard')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('master*') ? 'here show' : ''}} menu-accordion">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('penerimaan/penjualan') ? 'active' : ''}}" href="{{route('penerimaan.penjualan')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('pegawai*') ? 'here show' : ''}} menu-accordion">
									<span class="menu-link">
										<span class="menu-icon">
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('penerimaan*') ? 'here show' : ''}} menu-accordion">
									<span class="menu-link">
										<span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('penerimaan/penjualan') ? 'active' : ''}}" href="{{route('penerimaan.lainlain')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                <span class="menu-title">Penerimaan Lain-lain</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('pengeluaran*') ? 'here show' : ''}} menu-accordion">
									<span class="menu-link">
										<span class="menu-icon">
											<!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
											<span class="svg-icon svg-icon-2">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('pengeluaran/pembelian') ? 'active' : ''}}" href="{{route('pengeluaran.pembelian')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('pengeluaran/lainlain') ? 'active' : ''}}" href="{{route('pengeluaran.lainlain')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                <span class="menu-title">Pengeluaran Lain-lain</span>
                            </a>
                        </div>
                    </div>
                </div>
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('piutang*') ? 'here show' : ''}} menu-accordion">
									<span class="menu-link">
										<span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('piutang/penjualan') ? 'active' : ''}}" href="{{route('piutang.penjualan')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                        ...
                        <div data-kt-menu-trigger="click" class="menu-item {{request()->is('piutang/internal*') ? 'show' : ''}} menu-accordion">
                            <span class="menu-link">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                            ...
                            <div class="menu-sub menu-sub-accordion">
                                <div class="menu-item">
                                    <a class="menu-link {{request()->is('piutang/internal') ? 'active' : ''}}" href="{{route('piutang.internal')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                        <span class="menu-title">Piutang Internal</span>
                ...
                <div data-kt-menu-trigger="click" class="menu-item {{request()->is('hutang*') ? 'here show' : ''}} menu-accordion">
									<span class="menu-link">
										<span class="menu-icon">
                    ...
                    <div class="menu-sub menu-sub-accordion menu-active-bg">
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('hutang/pembelian') ? 'active' : ''}}" href="{{route('hutang.pembelian')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                <span class="menu-title">Hutang Pembelian</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link {{request()->is('hutang/lainlain') ? 'active' : ''}}" href="{{route('hutang.lainlain')}}">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
                                <span class="menu-title">Hutang Lain-lain</span>
                            </a>
                        </div>
                    </div>
                </div>
